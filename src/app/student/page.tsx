      ...
      <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
       <Card className="flex flex-col">
           ...
           <CardContent className="flex-1 p-4">
               <CardTitle className="text-xl mb-2">Generated Materials</CardTitle>
               <CardDescription>View the course materials generated by the AI chunking demo.</CardDescription>
           </CardContent>
           <CardFooter className="p-4 pt-0">
               <Link href="/student/materials" passHref className="w-full">
                   <Button className="w-full">
                       View Materials <ArrowRight className="ml-2" />
                   </Button>
               </Link>
           </CardFooter>
       </Card>
